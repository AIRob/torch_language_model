...
if __name__ == '__main__':
    generate_dataset(force_antonyms=False, remove_duplicates=False,
                     prefix='data/datasets/no_force_antonyms_no_remove_dups')
    generate_dataset(force_antonyms=False, remove_duplicates=True,
                     prefix='data/datasets/no_force_antonyms_remove_dups')
    generate_dataset(force_antonyms=True, remove_duplicates=False,
                     prefix='data/datasets/force_antonyms_no_remove_dups')
